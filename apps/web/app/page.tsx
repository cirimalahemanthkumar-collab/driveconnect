...
const learnerStats = [
  ...
  { label: "Mock OTP", value: "123456", tone: "indigo", delta: "MVP login" }
] as const;
  ...
  return (
    <main>
      <section className="relative min-h-[78vh] overflow-hidden">
        <img
          src="/images/hero-driveconnect.png"
          alt="Driving instructor and learner using DriveConnect"
        ...
        <div className="relative mx-auto flex min-h-[78vh] max-w-7xl items-center px-4 py-16">
          <div className="max-w-2xl text-white">
            ...
            <p className="mt-5 max-w-xl text-lg leading-8 text-blue-50">
              Discover nearby driving schools, compare courses, book flexible slots, pay securely, and track every class from one clean platform.
            </p>
            <div className="mt-7 flex flex-wrap gap-3">
              <Button href="/schools" variant="secondary">Find schools</Button>
              <Button href="/home" variant="ghost">Open customer site</Button>
            </div>
            <div className="mt-8">
              <TrustBadges />
            </div>
            <p className="mt-6 max-w-xl text-sm leading-6 text-blue-100">
              DriveConnect offers discovery, booking, class tracking, support, ratings, and licence process guidance. It does not guarantee licence outcomes.
            </p>
          </div>
        </div>
      </section>
